export const metadata = {
    ...
    icons: {
      ...
      shortcut: "/public/icon/shortcut-icon.png",
    },
    ...
    themeColor: "#0052cc",  // Updated theme color to reflect a more versatile and tech-focused branding
    backgroundColor: "#ffffff",  // Neutral background color to ensure compatibility across all branded materials
    keywords: [
