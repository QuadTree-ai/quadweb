    ...
    <div className="flex flex-col min-h-screen bg-black text-white">
      <div className="flex-grow pt-16 pb-8 md:pt-20 md:pb-16 lg:pt-24 lg:pb-24">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 mt-12">
          ...
          <p className="text-base sm:text-lg lg:text-xl mb-8 text-center text-gray-300 leading-relaxed">
          ...
          <p className="text-base sm:text-lg lg:text-xl mb-12 text-center text-gray-300 leading-relaxed">
