...
const SecuritySection = ({ item }: { item: SecurityInfo }) => (
    <section className="bg-gray-800 shadow rounded-lg p-6 mb-6 transition duration-300 hover:bg-gray-700 flex-grow">
    ...
    return (
        <div className="flex flex-col min-h-screen bg-black text-white py-8 px-4 sm:px-6 lg:px-8">
            <div className="max-w-7xl mx-auto">
                ...
                {/* Adjusting the container for side-by-side layout on larger screens */}
                ...
                <div className="flex justify-center mt-12">
                    <Button className="transition duration-300 hover:bg-blue-700" onClick={() => window.open("https://quadtree.ai/security-portal", "_blank")}>
