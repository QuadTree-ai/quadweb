...
function Navbar({ className }: { className?: string }) {
  ...
  return (
    ...
    >
      <div className="max-w-full mx-auto px-4 md:px-6 flex flex-col md:flex-row justify-between items-center h-20 mt-2 mb-2">
        <div className="flex justify-start items-center flex-1 space-x-4 md:space-x-6">
          <Link href="/" passHref>
            <div className="relative w-16 h-16 cursor-pointer mb-2">
              <Image
                src="/QuadTree.svg"
                alt="QuadTree Logo"
                fill
          ...
          <h1 className="text-xl font-bold block md:block">QuadTree.ai</h1> {/* Ensure this is visible on mobile */}
        </div>
