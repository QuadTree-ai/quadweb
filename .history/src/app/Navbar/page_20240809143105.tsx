...
function Navbar({ className }: { className?: string }) {
  ...
  return (
    ...
    >
      <div className="max-w-full mx-auto px-4 md:px-6 flex flex-col md:flex-row justify-between items-center h-20 mb-2 md:mb-0 mb-2">
        <div className="flex justify-start items-center flex-1 space-x-4 md:space-x-6 mb-2">
          <Link href="/" passHref>
          ...
          <h1 className="text-xl font-bold block md:block">QuadTree.ai</h1>
        </div>
