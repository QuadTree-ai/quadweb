...
function Navbar({ className }: { className?: string }) {
  ...
  return (
    <div className={cn("fixed top-0 inset-x-0 backdrop-blur-md bg-opacity-75 bg-black text-white z-50 mt-2", className)}>
      <div className="max-w-7xl mx-auto px-6 flex justify-between items-center h-24">
        <div className="flex justify-start items-center flex-1">
          <Link href="/" passHref>
            <div className="relative w-20 h-20 mr-6 cursor-pointer"> 
              <Image
                src="/QuadTree.svg"
                alt="QuadTree Logo"
                layout="fill"
