...
function Navbar({ className }: { className?: string }) {
  ...
  return (
    <div className={cn("fixed top-0 inset-x-0 backdrop-blur-md bg-opacity-75 bg-black text-white z-50 w-full", className)}>
      <div className="max-w-screen-xl mx-auto px-4 md:px-6 flex items-center justify-between h-16">
