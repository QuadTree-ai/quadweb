...
const cliniqxData = [
  {
    ...
    src: "/public/background/apple-1.jpg",  // Updated local image path
    content: (
  ...
  },
  {
    ...
    src: "/public/background/apple-2.jpg",  // Updated local image path
    content: (
  ...
  },
  {
    ...
    src: "/public/background/apple-3.jpg",  // Updated local image path
    content: (
