...
function Navbar({ className = "" }: { className?: string }) {
  ...
  return (
    <nav className={`fixed top-10 inset-x-0 max-w-2xl mx-auto z-50 ${className}`}>
      <Menu setActive={setActive}>
        {/* Logo as the first item in the navigation */}
        <div className="px-4 py-2">
          <Image
            src="/public/QuadTree.svg" // Update this path according to where your logo is stored
            alt="QuadTree Logo"
