    ...
    <div className={cn("fixed top-0 inset-x-0 bg-black text-white z-50 mt-2", className)}>
      <div className="max-w-7xl mx-auto px-4 flex justify-between items-center h-20">
        <div className="flex justify-start items-center flex-1">
          <div className="relative w-16 h-16 mr-4">  // Increased size from w-12 h-12 to w-16 h-16
            <Image
              src="/QuadTree.svg"
              alt="QuadTree Logo"
              layout="fill"
        ...
        <div className="flex-1"> {/* Placeholder for right-side elements or for balance */}
        </div>
      </div>
    </div>
  );
