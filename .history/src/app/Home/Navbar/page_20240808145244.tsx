    ...
    <div className={cn("fixed top-0 inset-x-0 bg-black text-white z-50", className)}>
      <div className="max-w-7xl mx-auto px-4 flex items-center justify-between h-16">
        <div className="flex items-center">
          <div className="relative w-12 h-12 mr-4">  {/* Adjusted logo size for better integration */}
            <Image
              src="/QuadTree.svg"
              alt="QuadTree Logo"
              layout="fill"  // Ensuring the image fills the div correctly
        ...
        <div className="flex-grow-0">  {/* Reserved space if needed */}
        </div>
      </div>
    </div>
  );
